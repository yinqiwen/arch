...
#endif // !defined(USE_FUTEX)
#endif // defined(linux)

#if defined(__i386__) || defined(__x86__) || defined(__X86__) || defined(__x86_64__)
#define ADAPTIVE_WAIT
#define ADAPTIVE_WAIT_LOOPS 1024
#endif

#ifdef USE_FUTEX
#include "concurrent/futexlock.h"
