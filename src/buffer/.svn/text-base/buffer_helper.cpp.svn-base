...
bool BufferHelper::ReadFixUInt64(Buffer& buffer, uint64_t& i, bool fromNetwork)
{
    uint64_t u;
...
bool BufferHelper::ReadFixInt64(Buffer& buffer, int64_t& i, bool fromNetwork)
{
    uint64_t u;
...
bool BufferHelper::ReadFixUInt32(Buffer& buffer, uint32_t& i, bool fromNetwork)
{
    uint32_t u;
...
bool BufferHelper::ReadFixInt32(Buffer& buffer, int32_t& i, bool fromNetwork)
{
    uint32_t u;
...
bool BufferHelper::ReadFixUInt16(Buffer& buffer, uint16_t& i, bool fromNetwork)
{
    uint16_t u;
...
bool BufferHelper::ReadFixInt16(Buffer& buffer, int16_t& i, bool fromNetwork)
{
    uint16_t u;
...
bool BufferHelper::ReadFixString(Buffer& buffer, string& str, bool fromNetwork)
{
    uint32_t len;
...
bool BufferHelper::ReadFixString(Buffer& buffer, char*& str, bool fromNetwork)
{
    uint32_t len;
    if (!ReadFixUInt32(buffer, len, fromNetwork))
    {
...
bool BufferHelper::WriteFixUInt64(Buffer& buffer, uint64_t i, bool toNetwork)
{
    if (toNetwork)
    {
        i = htonll(i);
...
bool BufferHelper::WriteFixUInt32(Buffer& buffer, uint32_t i, bool toNetwork)
{
    if (toNetwork)
    {
        i = htonl(i);
...
bool BufferHelper::WriteFixUInt16(Buffer& buffer, uint16_t i, bool toNetwork)
{
    if (toNetwork)
    {
        i = htons(i);
...
bool BufferHelper::WriteFixString(Buffer& buffer, const string& str,
        bool toNetwork)
{
    return WriteFixUInt32(buffer, str.size(), toNetwork) && str.size()
            == (size_t) buffer.Write(str.c_str(), str.size());
}
        ...
        bool toNetwork)
{
    ...
    else
    {
        ...
        return WriteFixUInt32(buffer, len, toNetwork) && len
                == (size_t) buffer.Write(str, len);
    }
}
...
{
    uint64_t u = i;
    return WriteVarUInt64(buffer, u);
}
...
{
    uint32_t u = i;
    return WriteVarUInt32(buffer, u);
}
...
{
    int32_t value = i;
    return WriteVarInt32(buffer, value);
}
...
bool BufferHelper::WriteVarString(Buffer& buffer, const char* str)
{
    ...
    {
        size_t len = strlen(str);
        return WriteVarUInt32(buffer, len) && len == (size_t) buffer.Write(str,
                len);
    }
}
