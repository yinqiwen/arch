...
//ChannelSink* ChannelPipeline::GetSink()
//{
//	if (NULL == m_sink)
//	{
...
//bool ChannelPipeline::SendUpstream(ChannelHandlerContext* ctx, ChannelEvent& e)
//{
//	RETURN_FALSE_IF_NULL(ctx);
//	ChannelHandler* handler = ctx->GetHandler();
...
//		        (ChannelUpstreamHandler*) handler;
//		//upstreamHandler->setCurrentEvent(e);
//		return upstreamHandler->HandleUpstream(*ctx, e);
//	}
//	return false;
//}
...
//                (ChannelDownstreamHandler*) handler;
//
//        return downstreamHandler->HandleDownstream(*ctx, e);
//    }
//    return false;
//}

//bool ChannelPipeline::SendUpstream(ChannelEvent& e)
//{
//    ChannelHandlerContext* ctx = GetActualUpstreamContext(m_head);
//    RETURN_FALSE_IF_NULL(ctx);
//    return SendUpstream(ctx, e);
//}

//bool ChannelPipeline::SendDownstream(ChannelEvent& e)
//{
//    ChannelHandlerContext* ctx = GetActualDownstreamContext(m_tail);
//    if (NULL == ctx)
//    {
//        return GetSink()->EventSunk(this, e);
//    }
//    return SendDownstream(ctx, e);
//}
